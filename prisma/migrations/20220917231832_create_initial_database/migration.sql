...
CREATE TABLE "teachersDisciplines" (
    ...
    "disciplinedId" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "teachersDisciplines" ADD CONSTRAINT "teachersDisciplines_disciplinedId_fkey" FOREIGN KEY ("disciplinedId") REFERENCES "disciplines"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
